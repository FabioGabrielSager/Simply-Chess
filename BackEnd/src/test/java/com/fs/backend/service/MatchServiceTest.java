...
import com.fs.backend.config.MappersConfig;
...
import com.fs.backend.service.imps.MatchServiceImp;
...
public class MatchServiceTest {
    ...
    public void moveTest1() {
        ...
        try {
            ...
            Assertions.assertEquals("A move cannot be made until another player is connected", err.getMessage());
        }
    }
    ...
    public void moveTest2() {
        ...
        try {
            ...
            Assertions.assertEquals("Cannot make a move in a finished game", err.getMessage());
        }
    }
    ...
    public void moveTest3() {
        ...
        try {
            ...
            Assertions.assertEquals("You cannot move in white's turn", err.getMessage());
        }
    }
    ...
    public void moveTest4() {
        ...
        try {
            ...
            Assertions.assertEquals("You cannot move in black's turn", err.getMessage());
        }
    }
    ...
    public void moveTest5() {
        ...
        try {
            ...
            Assertions.assertEquals("You can't move a black piece", err.getMessage());
        }
    }
    ...
    public void moveTest6() {
        ...
        try {
            ...
            Assertions.assertEquals("You can't move a white piece", err.getMessage());
        }
    }
